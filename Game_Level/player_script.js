    ...
    for (var i = 0; i < 100; i++) {
        ...
        if (newMarginLeft <= 70 & newMarginLeft >= -70) {
            ...
            if (ninjaMarginTop > 600) {
                ...
                document.getElementById("window1").style.opacity = "1";
    ...
    for (var i = 0; i < 100; i++) {
        ...
        if (newMarginLeft > 0 && newMarginLeft < 120) {
            ...
            if (attackAnimationId > 0) {
                ...
                document.getElementById("window2").style.opacity = "1";
    ...
    for (var i = 0; i < 100; i++) {
        ...
        if (newMarginLeft > 100 & newMarginLeft < 200) {
            ...
            if (slideAnimationId > 0) {
                ...
                document.getElementById("window3").style.opacity = "1";
                document.getElementById("score7").innerHTML = "Score : " + score;
                document.getElementById("score8").innerHTML = "Score : " + score;
